...
// finds the correct direction for the snake but it doesn't consider the snake's body 
...
bool Enemy::CheckFood()const{
  return atFood;
}

void Enemy::SetFood(bool state){
  atFood=state;
}
...
void Enemy::SetPoints(int value){
  points=value;
}